    ...
    <tr>
        ...
        <td align="right">
            ...
            <pre>
                ...
                Destination to : <?php echo strtoupper($cetak[0]['kd_des']); ?>
            </pre>
        </td>
    </tr>
  </table>
    ...
    <tbody>
      <?php foreach ($cetak as $row) { ?>
        <tr>
           ...
           <td align="left"><?php echo 'INR '.number_format(($row['harga_jadwal'])); ?></td>
        <tr>
        <?php } ?>
    </tbody>
    <tfoot>
        <tr>
            ...
            <td align="right" class="gray"><?php $total = count($cetak) * $cetak[0]['harga_jadwal']; echo 'INR '.number_format(($total));?></td>
        </tr>
    </tfoot>
  </table>
  <div id="container">
