			...
			<div class="row">
							...
							<form action="<?php echo base_url() ?>tiket/cekjadwal?>" method="get">
								...
								<div class="form-group">
									...
									<select name="tujuan" class="form-control js-example-basic-single">
										...
										<option value="<?php echo $row['kd_des'] ?>">
											<?php echo strtoupper($row['kd_des']); ?></option>
										<?php } ?>
									</select>
								</div>
				...
				<div class="col-lg-6">
					<div class="card mb-10">
						<div class="card-header">
							<i class="fas fa-info"></i> AVAILABLE BUS ROUTE
						</div>
						<div class="card-body">
							<table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
								...
								<tbody>
									...
									<tr>
										...
										<td style="vertical-align:middle;"><?php echo $value['kd_des'] ?></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
